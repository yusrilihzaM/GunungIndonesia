package com.kerjapraktek.gunungindonesia.ui.jabar
        ...
        viewModel.getGunung().observe(this,{data->
            ...
            gridGunungAdapter.setOnItemClickCallback(object :GridGunungAdapter.OnItemClickCallback{
                override fun onItemClicked(data: Gunung) {
                    Toast.makeText(this@JabarActivity, data.nama_gunung, Toast.LENGTH_SHORT).show()
                    val intent= Intent(this@JabarActivity, DetailActivity::class.java)
